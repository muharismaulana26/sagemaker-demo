...
def get_pipeline(
    ...
    role=None,
    default_bucket=None,
    model_package_group_name="ForecastPackageGroup",
    ...
    sklearn_processor = FrameworkProcessor(
        ...
        base_job_name=f"{base_job_prefix}/sklearn-forecast-preprocess",
    ...
    model_path = f"s3://{default_bucket}/{base_job_prefix}/ForecastTrain"
    ...
    transformer = Transformer(
        ...
        accept="text/csv",
        assemble_with="Line",
        output_path=f"s3://{default_bucket}/ForecastTransform",
        sagemaker_session=pipeline_session,
    )
    ...
    script_eval = ScriptProcessor(
        ...
        instance_type=processing_instance_type,
        instance_count=1,
        base_job_name=f"{base_job_prefix}/script-forecast-eval",
        sagemaker_session=pipeline_session,
        role=role,
    )
    ...
    evaluation_report = PropertyFile(
        name="ForecastEvaluationReport",
        output_name="evaluation",
        path="evaluation.json",
    )
    step_eval = ProcessingStep(
        name="EvaluateForecastModel",
        step_args=step_args,
    ...
    step_cond = ConditionStep(
        name="CheckRMSEForecastEvaluation",
        conditions=[cond_lte],
